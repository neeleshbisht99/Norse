...
#ifndef NORSE_NORSE_H
#define NORSE_NORSE_H
...
namespace NorseNet {
    ...
    /*
     * The class Norse is the highest level abstraction of NorseNet.
     */
    ...
    public:
         ...
         * Constructor.
         *
         * capacity: Capacity of Norse.
         *
         * inputDim: Input dimension.
         *
         * outputDim: Output dimension.
         *
         * mode: Mode of Norse (classify or predict).
         */

        Norse(uint32_t capacity, uint32_t inputDim, uint32_t outputDim, const std::string &mode);
        ...
        inline static std::string version() {
            return "NorseNet Core 2.10.36 (CPU Mode) By RootHarold.";
        }
     ...
     *
     * Returns a pointer to the object of class Norse.
     */
